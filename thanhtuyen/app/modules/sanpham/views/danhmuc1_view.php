...
<div class="row">
                    ...
                    <ul class="ul_hang">
                        <?php 
                            ...
                            <li><a 
                                ...
                                ?>
                                href="<?php echo site_url('sanpham/chucnang/'.$itemchucnang->id.'/'.url_title($itemchucnang->chucnang).'.html'); ?>" title="<?php echo $itemchucnang->chucnang; ?>"><?php echo $itemchucnang->chucnang; ?></a></li>
                            <?php
                            }
    ...
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="padding-top:10px;">
        <div class="image_top">
            <img src="images/thanhtuyen.jpg" title="điện thoại thanh tuyen" alt="điện thoại thanh tuyen">
        </div>
                ...
                <ul>                    
                    <?php 
                        ...
                        if(isset($dm2))
                        {
                            ...
                            $sqldmspd2=$this->db->get('tbldanhmucsanpham2')->row();    
                            ?>
                            <li><a href="<?php echo site_url(BoDau($sqldmspd2->danhmucsanphamcap2).'-dm2'.$sqldmspd2->id.'.html'); ?>" title="<?php echo $sqldmspd2->danhmucsanphamcap2; ?>"><strong><?php echo $sqldmspd2->danhmucsanphamcap2; ?></strong></a></li>
                            <?php
                        }
                        if(isset($dmhang))
                        {
                        ...
                        if(isset($cnkhkh))
                        {
                            $this->db->where('id',$cnkhkh);
                            $sqlchucnang=$this->db->get('tblchucnang')->row();
                        ?>
                        <li style="padding-left:10px;"><strong>Chức năng - <?php echo $sqlchucnang->chucnang; ?></strong></li>
                        <?php        
                        }
                        if(isset($cucusas))
                        {
                            $this->db->where('id',$cnkhkh);
                            $sqlmausac=$this->db->get('tblmausac')->row();
                        ?>
                        <li style="padding-left:10px;"><strong>Màu sắc - <?php echo $sqlmausac->tenmau; ?></strong></li>
                        <?php    
                        }
                    ?>
                ...
                <div class="row">
                    <div class="sanpham_mb">
                        <?php 
                            if($query->num_rows()>0)
                            {
                                foreach ($query->result() as $itemqrmb) 
                                {
                                ?>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <div class="sanpham_item">                                        
                                        <a href="<?php echo site_url(LocDau($itemqrmb->ten).'-sp'.$itemqrmb->id.'.html'); ?>" class="sanpham_item_img" title="<?php echo $itemqrmb->ten; ?>"><img src="<?php echo $itemqrmb->anh_thumb; ?>" title="<?php echo $itemqrmb->ten; ?>" alt="<?php echo $itemqrmb->ten; ?>"></a>
                                        <a href="<?php echo site_url(LocDau($itemqrmb->ten).'-sp'.$itemqrmb->id.'.html'); ?>" class="sanpham_item_name" title="<?php echo $itemqrmb->ten; ?>"><?php echo $itemqrmb->ten; ?></a>
                                        <p>
                                            <?php 
                                                if($itemqrmb->gia==0)
                                                {
                                                ...
                                                {
                                                    echo number_format($itemqrmb->gia,0,'.','.').'&nbsp;'.$itemqrmb->donvitinh;
                                                }
                                            ?>
                                        </p>
                                    </div>
