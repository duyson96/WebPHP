                ...
                if($sqlyeuthich->num_rows()>0)
                {
                    ...
                    <div class="phong_l_item">
                        ...
                        <div class="phong_l_item_nd">
                            <a href="" class="phong_l_item_name"><?php echo $itemyeuthich->ten; ?></a>
                ...
                <tr>
                    <?php 
                        if($query->num_rows()>0)
                        {
                            ...
                            {
                            ?>
                            <td><a href="<?php echo site_url(LocDau($itemquery->ten).'-p'.$itemquery->id.'.html'); ?>"><?php echo $itemquery->ten; ?></a></td>
                            <td><?php echo $itemquery->soluong; ?></td>
                            <td><?php echo $itemquery->gia; ?></td>
