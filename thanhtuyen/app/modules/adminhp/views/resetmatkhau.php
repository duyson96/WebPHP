...
<?php
    ...
    {
?>
<form method="post" name="frmAddContent" action="<?php echo  site_url().'/adminhp/do_rematkhau/' ?>" enctype="multipart/form-data">
<p>
    <strong>Tài khoản</strong>:    
    <label style="font-weight:bold;color:#3883cc;">
    <?php 
    $this->db->where('id',$id);
    $sqltaikhoanadview=$this->db->get('tbluser');
    echo $sqltaikhoanadview->row()->nguoidang; 
    ?></label>
</p>
<p>
...
<p><input class="myButton" type="submit" value="Đổi mật khẩu" />&nbsp;&nbsp;&nbsp;<input class="myButton" type="reset" value="Xóa" /></p>
</form>
<?php 
}
?>